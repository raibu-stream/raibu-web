...
export const checkoutState = writable<BuildYourTierState | BillingState | PaymentState>({
	stage: 'BuildYourTier',
	maxConcurrentUsersValue: writable([0]),
	maxConcurrentStreamsValue: writable([0]),
	maxBitrateValue: writable('3000 Kbps')
});
